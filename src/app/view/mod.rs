...
use iced::{
    Font,
    widget::{
        Button, Space, button, column, container, image, row, scrollable,
        slider, text,
    },
};
...
pub const ICON_FONT_BYTES: &[u8] =
    include_bytes!("../../../res/font/lucide.ttf");
...
macro_rules! control_button {
    ...
    ($icon:expr, $msg:expr, $style:expr) => {
        crate::app::view::icon_button(
            $icon,
            crate::app::view::CONTROL_BUTTON_SIZE / 2,
        )
