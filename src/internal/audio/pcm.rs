...
pub fn pcm_s8_to_ieee(sample: i8) -> f32 {
...
pub fn pcm_u16_to_ieee(sample: u16) -> f32 {
    const P_U16MAX_I: f32 = 2.0 / (u16::MAX as f32);
    (sample as f32 * P_U16MAX_I) - 1.0
}

pub fn pcm_s24_to_ieee(sample: i24) -> f32 {
...
pub fn pcm_u24_to_ieee(sample: u24) -> f32 {
    const P_U24MAX_I: f32 = 2.0 / (U24_MAX as f32);
    (sample.inner() as f32 * P_U24MAX_I) - 1.0
}

pub fn pcm_s32_to_ieee(sample: i32) -> f32 {
...
pub fn pcm_u32_to_ieee(sample: u32) -> f32 {
